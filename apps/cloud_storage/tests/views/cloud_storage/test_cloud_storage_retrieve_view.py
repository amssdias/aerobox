...
class CloudStorageRetrieveTests(APITestCase):
    ...
    @patch("apps.cloud_storage.integrations.s3.storage.S3StorageClient.generate_presigned_download_url")
    ...
    @patch.object(S3StorageClient, "generate_presigned_download_url", return_value=None)
