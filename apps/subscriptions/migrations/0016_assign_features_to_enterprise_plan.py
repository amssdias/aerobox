# Generated by Django 4.2.17 on 2025-07-03 14:19
...
def assign_basic_features_to_enterprise_plan(apps, schema_editor):
    Plan = apps.get_model("subscriptions", "Plan")
    Feature = apps.get_model("features", "Feature")
    PlanFeature = apps.get_model("subscriptions", "PlanFeature")

    try:
        enterprise_plan = Plan.objects.get(name__en="Enterprise", is_free=False)
...
def unassign_basic_features_from_enterprise_plan(apps, schema_editor):
    Plan = apps.get_model("subscriptions", "Plan")
    PlanFeature = apps.get_model("subscriptions", "PlanFeature")
    ...
    PlanFeature.objects.filter(plan=enterprise_plan, feature__code__in=feature_codes).delete()


class Migration(migrations.Migration):
    dependencies = [
        ("subscriptions", "0015_create_enterprise_plan"),
        ("features", "0004_create_basic_features"),
    ]

    operations = [
        migrations.RunPython(
            assign_basic_features_to_enterprise_plan,
            unassign_basic_features_from_enterprise_plan,
        )
    ]
