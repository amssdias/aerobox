...
class SubscriptionUpdatedHandlerTest(TestCase):
    ...
    def test_update_subscription_no_previous_plan_does_nothing(self, mock_get_sub, mock_change):
    ...
    @patch.object(SubscriptionUpdatedHandler, "change_plan_subscription")
    def test_update_subscription_triggers_change_when_previous_plan_matches_current(self, mock_change):
        self.handler.process()

        mock_change.assert_called_once_with(self.subscription)
    ...
    @patch.object(SubscriptionUpdatedHandler, "change_plan_subscription")
    def test_update_subscription_handles_none_subscription_safely(self, mock_change):
