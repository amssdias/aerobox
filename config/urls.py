...
urlpatterns += [
    # path("api/docs/swagger/", SpectacularSwaggerView.as_view(url_name="schema", authentication_classes=[SessionAuthentication], permission_classes=[IsSuperUser]), name="swagger-ui"),
